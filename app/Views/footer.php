                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p class="text-copyright">
                            पता : विकास प्रबंधन संस्थान,दूसरी मंजिल,उद्योग भवन, पूर्वी गाँधी मैदान, पटना - 800004
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <p class="text-copyright">
                            <a href="www.dmi.ac.in">www.dmi.ac.in</a>
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <p class="text-copyright">
                            <span>cep@dmi.ac.in</span>
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <p class="text-copyright">
                            <span>7091496207</span>
                        </p>
                    </div>
                </div>
            </div>
